    ...
    <footer className="bg-surface border-t border-border pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="space-y-6">
            ...
            <p className="text-textSecondary leading-relaxed">
              Cutting-edge technological solutions in media, IT, and security
              industries. Protecting lives and assets across Africa and beyond.
            </p>
        ...
        <div className="pt-8 border-t border-border text-center text-textSecondary text-sm">
          <p>
            © {new Date().getFullYear()} Visionspeaks Multimedia Ltd. All rights
            reserved.
          </p>
        </div>
      </div>
