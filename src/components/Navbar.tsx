        ...
        <div className="flex justify-between items-center">
          <Link href="/" className="flex items-center space-x-2 group">
            ...
            <div className="flex flex-col">
              <span className="text-xl font-bold tracking-tighter leading-none">VISIONSPEAKS</span>
              <span className="text-[10px] text-primary tracking-[0.2em] font-medium">MULTIMEDIA LTD</span>
            </div>
          </Link>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div 
            ...
            exit={{ opacity: 0, y: -20 }}
            className="md:hidden absolute top-full left-0 w-full bg-surface border-b border-border p-4"
          >
